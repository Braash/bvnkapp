  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div className="w-2/5 bg-white rounded-lg shadow-lg p-8 relative">
        <h4 className="text-center text-xl font-semibold mb-4">Pay with BTC</h4>
		...
		<div className="border-t border-gray-300 w-full h-px bg-gray-300 mt-2 mb-2" />
			<div className="flex justify-between">
					<div className="text-center md:text-sm text-xs text-gray-500">Amount due</div>
					<div className="flex justify-between">
		...
		<div className="border-t border-gray-300 w-full h-px bg-gray-300 mt-2 mb-2" />
			<div className="flex justify-between">
					...
					<div>
						...
						/> :
						<QuoteTimer expiryDate={paymentSummaryData?.acceptanceExpiryDate} expiryFunction={handleExpiredQuote} />}
					</div>
			</div>
		<div className="border-t border-gray-300 w-full h-px bg-gray-300 mt-2 mb-2" />
        </div>
